...
namespace MainControl.BLL
{
    public class PermissionService
    {
       SqlsugarMyClient client=new SqlsugarMyClient();
        ...
        /// </summary>
        /// <returns></returns>
        public   List<PermissionModel> QueryList()
        {
             List<PermissionModel> list =  db.Queryable<PermissionModel>().ToList();
             return list;
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<List<PermissionModel>> QueryListAsync()
        {
            //var db = client.Queryable<List<UserInfo>>(null, "dbo.U_User").ToList();

            List<PermissionModel> list = await db.Queryable<PermissionModel>().ToListAsync();
            return list;
