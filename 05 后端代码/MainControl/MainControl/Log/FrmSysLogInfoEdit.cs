...
{
    public partial class FrmSysLogInfoEdit : Form
    {
        ...
        #endregion
        public FrmSysLogInfoEdit(FrmSysLogInfo frm)
        {
            InitializeComponent();
            Init();
        ...
        public FrmSysLogInfoEdit(FrmSysLogInfo frm, ref DataGridViewRow dvr)
        {
            InitializeComponent();
            Init();
