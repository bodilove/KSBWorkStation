    ...
    public class P_DetailBLL
    {
        ...
        public P_Detail GetDetailsInfoById(int id)
        {
            try
            {
                ...
                {
                    return GlobalResources.GetInfo<P_Detail>("P_Detail", "Id", id, mydbUUTDB);
                }
        ...
        public List<P_Detail> GetDetailList(int record, int currentpage, ref long allines, string condion, bool IsPage)
        {
            try
            {
                using (MyDB_Sql mydbUUTDB = new MyDB_Sql(GlobalResources.dbserver, GlobalResources.dbname, GlobalResources.userid, GlobalResources.password))
                {
                    if (IsPage)
                    {
                        return GlobalResources.GetPages<P_Detail>("P_Detail", record, currentpage, ref allines, "Id", condion, mydbUUTDB);
                    }
                    else
                    {
                        return GlobalResources.GetListInfo<P_Detail>("P_Detail", condion, mydbUUTDB);
                    }
                }
            }
            catch
        ...
        public List<P_Detail> GetDetailList(string productnum, string stationnum)
        {
            try
            {
                using (MyDB_Sql mydbUUTDB = new MyDB_Sql(GlobalResources.dbserver, GlobalResources.dbname, GlobalResources.userid, GlobalResources.password))
                {
                    ...
                    return GlobalResources.GetListInfo<P_Detail>("P_Detail", sql, mydbUUTDB);
                }
            }
            catch
            {
        ...
        public bool AddUpdateDeleteP_Detail(P_Detail P_Detail, string condition, string operType)
        {
            ...
            try
            {
                using (MyDB_Sql mydbUUTDB = new MyDB_Sql(GlobalResources.dbserver, GlobalResources.dbname, GlobalResources.userid, GlobalResources.password))
                {
                    ...
                    {
                        case "ADD":
                            yorn = GlobalResources.Add<P_Detail>(P_Detail, "P_Detail", mydbUUTDB, true);
                            break;
                        case "UPDATE":
                            yorn = GlobalResources.Update<P_Detail>(P_Detail, "P_Detail", condition, mydbUUTDB);
                            break;
                        case "DELETE":
                            yorn = GlobalResources.Delete("P_Detail", condition, mydbUUTDB);
                            break;
                        default:
                            break;
                    }
