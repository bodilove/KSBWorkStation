...
{
    public partial class MultiSelectTree2 : TreeView
    {
        public MultiSelectTree2()
        {
            InitializeComponent();
        }

        public MultiSelectTree2(IContainer container)
        {
            container.Add(this);
            InitializeComponent();
        }
        ...
        protected override void OnDragDrop(DragEventArgs drgevent)
        {
            ...
            if (DropNode != null && DropNode.Parent != myNode && DropNode != myNode)
            {
                ...
                if (DropNode.TreeView != DragNode.TreeView)
                {
                ...
                else
                {
                    ...
                    else if (DropNode.Level == 0 && DragNode.Level == 1)
                    {
                        myNode.Remove();
                        // this.Nodes.Insert(DropNode.Index, DragNode);
                        DropNode.Nodes.Add(DragNode);
            ...
            if (DropNode == null)
            {
                ...
                if (DragNode.Level == 0)
                {
                    ...
                    else
                    {
                        ...
                        {
                        myNode.Remove();
                        this.Nodes[Nodes.Count-1].Nodes.Add(DragNode);
                        this.SelectedNode = DragNode;
                        }
                    }
                }
